  ...
  return (
    <section id="certificates" className="py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-4xl font-extrabold text-gray-900 mb-8">My Certificates</h2>
        <p className="text-lg text-gray-700 mb-12">
          Here are some of my professional certifications in Data Analytics and Engineering.
        </p>
            ...
            >
              ...
              <div className="p-6 text-center">
                ...
                <div className="mt-4 flex justify-center space-x-4">
                  {/* View Button */}
                  <a
                    href={`/my-portfolio-website/certificates/${cert.file}`}
                    target="_blank"
